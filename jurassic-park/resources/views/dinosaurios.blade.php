...
<head>
    ...
    <style>
        ...
        .btn-asignar  { background: #6366f1; color: white; border: none; padding: 6px 12px; border-radius: 6px; cursor: pointer; flex: 1; }
...
<div class="navbar">
    <div class="logo">🦖 Jurassic Park — Dinosaurios</div>
    <div class="nav-right">
...
<div class="container">
    ...
    <button class="btn-save" onclick="showCreateForm()">➕ Nuevo Dinosaurio</button>
    ...
    <div class="form-box" id="asignarBox" style="display:none">
        ...
        <p id="asignarDinoNick" style="color:#facc15"></p>
